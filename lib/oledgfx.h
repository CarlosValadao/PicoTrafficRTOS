...
#define OLEDGFX_LINE1 UINT8_T_CONSTANT(0)   // Primeira linha do display
#define OLEDGFX_LINE2 UINT8_T_CONSTANT(8)   // Segunda linha
#define OLEDGFX_LINE3 UINT8_T_CONSTANT(16)  // Terceira linha
#define OLEDGFX_LINE4 UINT8_T_CONSTANT(24)  // Quarta linha
#define OLEDGFX_LINE5 UINT8_T_CONSTANT(32)  // Quinta linha
#define OLEDGFX_LINE6 UINT8_T_CONSTANT(40)  // Sexta linha
#define OLEDGFX_LINE7 UINT8_T_CONSTANT(48)  // Sétima linha
#define OLEDGFX_LINE8 UINT8_T_CONSTANT(56)  // Oitava linha

// Definições das coordenadas das colunas do display OLEDGFX
// Cada coluna tem um deslocamento horizontal de 8 pixels
#define OLEDGFX_COL1  UINT8_T_CONSTANT(0)   // Primeira coluna do display
#define OLEDGFX_COL2  UINT8_T_CONSTANT(8)   // Segunda coluna
#define OLEDGFX_COL3  UINT8_T_CONSTANT(16)  // Terceira coluna
#define OLEDGFX_COL4  UINT8_T_CONSTANT(24)  // Quarta coluna
#define OLEDGFX_COL5  UINT8_T_CONSTANT(32)  // Quinta coluna
#define OLEDGFX_COL6  UINT8_T_CONSTANT(40)  // Sexta coluna
#define OLEDGFX_COL7  UINT8_T_CONSTANT(48)  // Sétima coluna
#define OLEDGFX_COL8  UINT8_T_CONSTANT(56)  // Oitava coluna
#define OLEDGFX_COL9  UINT8_T_CONSTANT(64)  // Nona coluna
#define OLEDGFX_COL10 UINT8_T_CONSTANT(72)  // Décima coluna
#define OLEDGFX_COL11 UINT8_T_CONSTANT(80)  // Décima primeira coluna
#define OLEDGFX_COL12 UINT8_T_CONSTANT(88)  // Décima segunda coluna
#define OLEDGFX_COL13 UINT8_T_CONSTANT(96)  // Décima terceira coluna
#define OLEDGFX_COL14 UINT8_T_CONSTANT(104) // Décima quarta coluna
#define OLEDGFX_COL15 UINT8_T_CONSTANT(112) // Décima quinta coluna
#define OLEDGFX_COL16 UINT8_T_CONSTANT(120) // Décima sexta coluna
